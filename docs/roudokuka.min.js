...
var Roudokuka = exports.Roudokuka = function () {
  ...
  _createClass(Roudokuka, [{
    ...
    value: function _startResumer() {
      this.resumer = setInterval(function () {
    ...
    value: function getUtterance(line) {
      ...
      var advancedCallbacks = { list: ['onend'] };
      advancedCallbacks.list.map(function (name) {
        if (Object.prototype.toString.call(_this2.utterance[name]) == '[object Function]') {
          return advancedCallbacks[name] = _this2.utterance[name];
        }
      });
