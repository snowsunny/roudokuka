...
var baseMerge = __webpack_require__(32),
...
exports.Roudokuka = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _Libretto = __webpack_require__(31);

var _Libretto2 = _interopRequireDefault(_Libretto);
...
var Roudokuka = exports.Roudokuka = function () {
  function Roudokuka(texts, options) {
    _classCallCheck(this, Roudokuka);

    this.libretto = new _Libretto2.default(texts);
    this.voices = [];
    ...
    this.options = (0, _merge3.default)(this.defaultOptions, options);
  ...
  _createClass(Roudokuka, [{
    key: '_startResumer',
    value: function _startResumer() {
      this.resumer.push(setInterval(function () {
        speechSynthesis.resume();
      }, 5000));
    }
  }, {
    key: '_stopResumer',
    value: function _stopResumer() {
      if (this.resumer.length) {
        this.resumer.forEach(function (id) {
          clearInterval(id);
        });
        this.resumer = [];
      }
    ...
    key: 'getUtterance',
    value: function getUtterance(line) {
      var _this2 = this;

      this.utterance = new SpeechSynthesisUtterance();
      (0, _merge3.default)(this.utterance, this.options, line);
      ...
      var advancedCallbacks = { list: ['onend', 'onpause', 'onresume'] };
      advancedCallbacks.list.forEach(function (name) {
        if (Object.prototype.toString.call(_this2.utterance[name]) == '[object Function]') {
          advancedCallbacks[name] = _this2.utterance[name];
        }
      });

      this.utterance.onend = function (e) {
        if (_this2.interrupted) {
          _this2.interrupted = false;
        } else {
          if (advancedCallbacks.onend) {
            advancedCallbacks.onend(e, _this2.currentLine);
          }
          _this2.start();
        }
      };
      this.utterance.onpause = function (e) {
        _this2._stopResumer();
        if (advancedCallbacks.onpause) {
          advancedCallbacks.onpause(e, _this2.currentLine);
        }
      };
      this.utterance.onresume = function (e) {
        if (_this2.resumer.length == 0 && advancedCallbacks.onresume) {
          advancedCallbacks.onresume(e, _this2.currentLine);
          _this2._startResumer();
        }
      };
    ...
    key: 'start',
    value: function start(lineIndex) {
...
var Libretto = function () {
  function Libretto(linesInfo) {
    _classCallCheck(this, Libretto);

    this.curentLineIndex = 0;
    this.lines = this._createLines(linesInfo);
  }

  _createClass(Libretto, [{
    key: '_createLines',
    value: function _createLines(linesInfo) {
      return linesInfo.map(function (lineInfo, index) {
        if (Object.prototype.toString.call(lineInfo) == '[object String]') {
          return { index: index, text: lineInfo };
        } else {
          return (0, _merge3.default)(lineInfo, { index: index });
        }
      });
    }
  }, {
...
var Stack = __webpack_require__(33),
    ...
    baseMergeDeep = __webpack_require__(67),
    isObject = __webpack_require__(0),
...
var ListCache = __webpack_require__(3),
    stackClear = __webpack_require__(39),
    stackDelete = __webpack_require__(40),
...
var assignMergeValue = __webpack_require__(18),
    ...
    toPlainObject = __webpack_require__(83);
